...
fn draw_rect_outline(
    ...
    callbacks.draw_line(&colour, thickness, y1, x1, y1, x2);
    callbacks.draw_line(&colour, thickness, y1, x1, y2, x1);

    callbacks.draw_line(&colour, thickness, y2, x2, y2, x1);
    callbacks.draw_line(&colour, thickness, y2, x2, y1, x2);
}
